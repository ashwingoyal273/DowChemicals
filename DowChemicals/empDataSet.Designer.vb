...
Partial Public Class empDataSet
    ...
    Partial Public Class employeeDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddemployeeRow(ByVal username As String, ByVal password As String) As employeeRow
...
Namespace empDataSetTableAdapters
    ...
    Partial Public Class employeeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `employee` WHERE ((`username` = ?) AND ((? = 1 AND `password` IS NULL"& _ 
                ") OR (`password` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `employee` (`username`, `password`) VALUES (?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `employee` SET `username` = ?, `password` = ? WHERE ((`username` = ?) AND "& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.DowChemicals.My.MySettings.Default.empConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT username, [password] FROM employee"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As empDataSet.employeeDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As empDataSet.employeeDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As empDataSet.employeeDataTable = New empDataSet.employeeDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As empDataSet.employeeDataTable) As Integer
